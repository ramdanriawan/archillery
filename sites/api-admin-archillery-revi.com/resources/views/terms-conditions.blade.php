...
<head>
    ...
    <title>Preview</title>
    <link rel="apple-touch-icon-precomposed" sizes="57x57" href="https://www.privacypolicyonline.com/assets/images/apple-touch-icon-57x57.png" />
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="https://www.privacypolicyonline.com/assets/images/apple-touch-icon-114x114.png" />
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="https://www.privacypolicyonline.com/assets/images/apple-touch-icon-72x72.png" />
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="https://www.privacypolicyonline.com/assets/images/apple-touch-icon-144x144.png" />
    <link rel="apple-touch-icon-precomposed" sizes="60x60" href="https://www.privacypolicyonline.com/assets/images/apple-touch-icon-60x60.png" />
    <link rel="apple-touch-icon-precomposed" sizes="120x120" href="https://www.privacypolicyonline.com/assets/images/apple-touch-icon-120x120.png" />
    <link rel="apple-touch-icon-precomposed" sizes="76x76" href="https://www.privacypolicyonline.com/assets/images/apple-touch-icon-76x76.png" />
    <link rel="apple-touch-icon-precomposed" sizes="152x152" href="https://www.privacypolicyonline.com/assets/images/apple-touch-icon-152x152.png" />
    <link rel="icon" type="image/png" href="https://www.privacypolicyonline.com/assets/images/favicon-196x196.png" sizes="196x196" />
    <link rel="icon" type="image/png" href="https://www.privacypolicyonline.com/assets/images/favicon-96x96.png" sizes="96x96" />
    <link rel="icon" type="image/png" href="https://www.privacypolicyonline.com/assets/images/favicon-32x32.png" sizes="32x32" />
    <link rel="icon" type="image/png" href="https://www.privacypolicyonline.com/assets/images/favicon-16x16.png" sizes="16x16" />
    <link rel="icon" type="image/png" href="https://www.privacypolicyonline.com/assets/images/favicon-128x128.png" sizes="128x128" />
    <meta name="application-name" content="&nbsp;" />
    <meta name="msapplication-TileColor" content="#FFFFFF" />
    <meta name="msapplication-TileImage" content="https://www.privacypolicyonline.com/assets/images/mstile-144x144.png" />
    <meta name="msapplication-square70x70logo" content="https://www.privacypolicyonline.com/assets/images/mstile-70x70.png" />
    <meta name="msapplication-square150x150logo" content="https://www.privacypolicyonline.com/assets/images/mstile-150x150.png" />
    <meta name="msapplication-wide310x150logo" content="https://www.privacypolicyonline.com/assets/images/mstile-310x150.png" />
    <meta name="msapplication-square310x310logo" content="https://www.privacypolicyonline.com/assets/images/mstile-310x310.png" />
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p>Welcome to Archillery!</p>
                        <p>These terms and conditions outline the rules and regulations for the use of Archillery's
                            Website, located at privacypolicyonline.com.</p>
                        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to
                            use Archillery if you do not agree to take all of the terms and conditions stated on this
                            page.</p>
                        <p>The following terminology applies to these Terms and Conditions, Privacy Statement and
                            ...
                            therefore as referring to same. Our Terms and Conditions were created with the help of the
                            <a href="https://www.privacypolicyonline.com/terms-conditions-generator/">Terms & Conditions
                                Generator</a>.</p>
                        <h3><strong>Cookies</strong></h3>
                        <p>We employ the use of cookies. By accessing Archillery, you agreed to use cookies in agreement
                            with the Archillery's Privacy Policy.</p>
                        ...
                        <p>Unless otherwise stated, Archillery and/or its licensors own the intellectual property rights
                            for all material on Archillery. All intellectual property rights are reserved. You may
                            access this from Archillery for your own personal use subjected to restrictions set in these
                            terms and conditions.</p>
                        <p>You must not:</p>
                        <ul>
                            <li>Republish material from Archillery</li>
                            <li>Sell, rent or sub-license material from Archillery</li>
                            <li>Reproduce, duplicate or copy material from Archillery</li>
                            <li>Redistribute content from Archillery</li>
                        </ul>
                        <p>This Agreement shall begin on the date hereof.</p>
                        <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                            information in certain areas of the website. Archillery does not filter, edit, publish or
                            review Comments prior to their presence on the website. Comments do not reflect the views
                            and opinions of Archillery,its agents and/or affiliates. Comments reflect the views and
                            opinions of the person who post their views and opinions. To the extent permitted by
                            applicable laws, Archillery shall not be liable for the Comments or for any liability,
                        ...
                        <p>Archillery reserves the right to monitor all Comments and to remove any Comments which can be
                        ...
                        <p>You hereby grant Archillery a non-exclusive license to use, reproduce, edit and authorize
                        ...
                        <p>We will approve link requests from these organizations if we decide that: (a) the link would
                            ...
                            visibility of the hyperlink compensates the absence of Archillery; and (d) the link is in
                        ...
                        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking
                            to our website, you must inform us by sending an e-mail to Archillery. Please include your
                        ...
                        <p>No use of Archillery's logo or other artwork will be allowed for linking absent a trademark
                            license agreement.</p>
